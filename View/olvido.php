...
<Div class="contenedor">
        <div class="contenedor-texto-imagen" align="center">
            ...
            <h1 class="Texto-correo"><center>Olvido Contraseña</center></h1>
            <hr>
    </Div>    
    <div class="content">
        <h2 id="Nombre">
        ...
        <p>Según tu solicitud de recuperarción de contraseña; nos permitimos enviar una de respaldo, para que ingreses al sistema</p><br>
